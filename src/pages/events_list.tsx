...
const EventsList: React.FC = () => {
  ...
  const pagePermissions = getPermissionsForPage("events");
        ...
        <div className="col-lg-8">
          <Box sx={{ height: 800, width: "100%" }}>
              ...
              <DataGrid
                ...
                localeText={{ noRowsLabel: pagePermissions.canViewTable ? "No events found"  : "You do not have permission to see this content"}}
      ...
      {selectedRow && (
        <DetailsDialog
          ...
          fields={[
            ...
            { label: "Country", value: selectedRow.country_name || selectedRow.country_id },
            { label: "State", value: selectedRow.state_name || selectedRow.state_id },
            { label: "City", value: selectedRow.city_name || selectedRow.city_id },
