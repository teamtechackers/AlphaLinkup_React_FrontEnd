...
import { FundSizeModel, FundSizeModelLabels } from "../models/fund_size_model";
...
const FundSizeList: React.FC = () => {
    ...
    const columns = useMemo(() => [
        ...
        { field: FundSizeModelLabels.INVESTMENT_RANGE, headerName: FUND_SIZE_STRINGS.TABLE.HEADER_INVESTMENT_RANGE, flex: 1 },
        {
                ...
                <div className="col-lg-4">
                    <div className="card shadow-sm">
                        <div className="card-header" style={{ backgroundColor: COLORS.lightGray }}>
                            <h5 className="mb-0">{editing ? FUND_SIZE_STRINGS.FORM.EDIT_FUND_SIZE : FUND_SIZE_STRINGS.FORM.ADD_FUND_SIZE}</h5>
                        </div>
                                ...
                                <div className="d-flex gap-2 mt-3">
                                    ...
                                    {editing && (
                                        <button
                                            ...
                                            type="button"
                                            className="btn"
                                            onClick={() => { setEditing(null); setInvestmentRange(""); setStatus("1"); }}
                                        >
